...
export const WobbleCard = ({
  ...
  return (
    <motion.section
      ...
      className={cn(
        "mx-auto md:w-full w-4/5 bg-indigo-800  relative rounded-2xl overflow-hidden",
        containerClassName
      )}
    >
      <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-5xl mx-auto w-full">
        ...
        >
          <div className="max-w-xs">
            ...
            Hello! I'm Hamza Nazeer, a passionate Full-Stack Flutter Developer with a deep love for creating high-performance, cross-platform mobile and web applications. 
            </p>
          </div>
          <Image
        ...
        <WobbleCard containerClassName="col-span-1 min-h-[300px]">
          ...
          My journey in the tech world began with a curiosity for how things work, and it has blossomed into a rewarding career where I get to solve complex problems and innovate daily.
          </p>
        </WobbleCard>
